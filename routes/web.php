...
Route::middleware(['auth:sanctum', config('jetstream.auth_session'), 'verified'])->group(function () {
    ...
    Route::get('/admin/order-manage',[ProductController::class,'manage'])->name('admin.manage-order');
    Route::get('/admin/order-detail/{id}',[ProductController::class,'detail'])->name('admin.manage-detail');
    Route::get('/admin/order-invoice/{id}',[ProductController::class,'invoice'])->name('admin.manage-invoice');
    Route::get('/admin/order-delete/{id}',[ProductController::class,'delete'])->name('admin.manage-delete');
